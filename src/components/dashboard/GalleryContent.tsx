  ...
  return (
    <main className="flex-1 py-4 px-5 md:h-[600px] 2xl:h-[770px] overflow-y-auto">
      <section className="flex items-center justify-between border-[1px] border-[#E4E8E5] bg-[#FFFFFF] py-5 px-4 rounded-[4px]">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center text-[#999999]">
            <p className="pr-2">503 Photos</p>
            {/*Divider*/}
            <div className="w-[1px] h-3 bg-[#C7CFC9] hidden md:block"></div>
            <p className="pl-2">50 Videos</p>
          </div>
        </div>
      ...
      <section className="flex flex-wrap mt-5 gap-5">
        {/* Single Image */}
        <div className="inline-block grow" onClick={() => setPicModal(true)}>
          <div className="relative h-[227px]">
            <img src="/gallery/gallery3.svg" alt="" className="invisible" />
            <div
              className="absolute inset-0 bg-cover bg-center rounded-[4px]"
              style={{ backgroundImage: 'url("/gallery/gallery3.svg")' }}
            ></div>
          </div>
          ...
          <div className="flex items-start justify-between mt-3">
            <div className="flex flex-col">
              ...
              <small className="text-[#999999] font-medium">Today</small>
            </div>
        ...
        <div className="inline-block grow">
          <div className="relative h-[227px]">
            <img src="/gallery/gallery4.svg" alt="" className="invisible" />
            <div
              className="absolute inset-0 bg-cover bg-center rounded-[4px]"
              style={{ backgroundImage: 'url("/gallery/gallery4.svg")' }}
            ></div>
          </div>
      ...
      <Modal isOpen={confModal} useDefaultWidth>
        ...
        <div className="w-full flex items-center gap-5">
          <button
            className="w-full flex justify-center cta-btn border-[#8C5C5C] bg-base-100 text-[#8C5C5C] group relative overflow-hidden rounded-[5px] mt-5"
            onClick={() => setConfModal(false)}
          >
